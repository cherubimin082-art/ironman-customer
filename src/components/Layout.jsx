              ...
              <NavLink key={path} to={path}>
                {({ isActive }) => (
                  <div className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors cursor-pointer select-none ${
                    ...
                    <Icon
                      size={18}
                      className={isActive ? 'text-red-600 shrink-0' : 'text-slate-500 shrink-0'}
                    />
                    <span className={`text-sm flex-1 ${isActive ? 'font-semibold text-red-700' : 'font-medium'}`}>
                      {label}
                    </span>
        ...
        <div className="px-3 py-3 border-t border-slate-100 space-y-0.5">
          <div className="flex items-center gap-3 px-3 py-2.5 rounded-xl">
            <div className="w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center shrink-0">
              <span className="text-red-700 text-sm font-bold">{firstName[0]}</span>
            </div>
